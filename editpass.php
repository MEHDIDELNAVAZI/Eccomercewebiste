    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Password   = 'tovazfehwkvhnibc';
                ...
                $mail->Body    = 'Here is the verification link <b><a href="http://shop.test/changepassword.php?reset=' . $code . '">http://shop.test/changepassword?reset=' . $code . '</a></b>';
                    $mail->send();
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <div class="social-icons">
                            <p>Back to! <a href="http://shop.test/login">Login</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
