...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="s_m_form" method="post">
                        <input name="size_n" type="text" id="s_n" placeholder=" Size name  ">
                        <input   hidden  type="text" id="s_id">
                        <br>
                         <input hidden  name="size_id" type="text" id="size_id">
                </div>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color:black">Are you sure you want to delete this Size   ?!</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="add_s_m" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog   modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">  <h5> Add Size </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form id="addsize_form" method="post">
                        <input name="size_name" type="text" id="add_size_name" placeholder=" Size name  to add ">
    ...
    <div class="container">
        ...
        <table>
            ...
            <?php
            if (isset($_POST["all"])) {
                $q  = $mysqli->query("SELECT * FROM  tbl_size ");
                $counter  = 1;
                if (mysqli_num_rows($q) ==  0) {
                    ...
                    while ($row = mysqli_fetch_assoc($q)) {
                        ...
                        echo  '<input  hidden  type="text"  name ="size_id" value= "'. $row["size_id"] .'">';
                        echo  '<input  hidden  type="text"  name ="size_name" value= "'. $row["size_name"] .'">';
            ...
            if ($_POST["pagination"]) {
                ...
                $querypageination  = $mysqli->query("SELECT * FROM  tbl_size  LIMIT $start,5 ");
                $counter  = $start + 1;
            ...
            if (isset($_POST["searchstr"])) {
                ...
                $query1  = $mysqli->query("SELECT * FROM  tbl_size WHERE  size_name  LIKE '$str%'  limit 5");
                $counter  =  1;
            ...
            <i class='bx bx-message-square-minus'></i>
                ...
                if ($_POST["pagination"] != "true"  && !isset($_POST["all"])) {
                    $query  = $mysqli->query("SELECT * FROM  tbl_size limit 5");
        ...
        <div class="pagination  mt-4 ">
            <?php
            $query2  = $mysqli->query("SELECT * FROM  tbl_size ");
    ...
    <script>
        $("#edittcat button").click(function() {
            ...
            var size_id = s[0].value;
            var size_name  =s[1].value;  
            $("#s_n").val(size_name) ; 
            $("#s_id").val(size_id) ; 
        ...
        $("#eidtsocial_media").click(function() {
           var editedsize =  $("#s_n").val(); 
           var  sizeid  = $("#s_id").val()  ;
           
            $.ajax({
                type: "post",
                url: "edit_add_delete_size.php?edit=ture",
                data: {
        ...
        $(".de").click(function() {
            ...
            $("#delete_size").click(function() {
                ...
                setTimeout(function() {
                    ...
                    $.ajax({
                        type: "post",
                        url: "edit_add_delete_size.php?delete=true",
                        data: {
                            size_id: size_id
                        },
        ...
        $("#addsocilamedia").click(function() {
            ...
            var  sizename = $("#addsize_form input ").val() ;
            ...
            if (sizename=="") {
                ...
                $.ajax({
                type: "post",
                url: "edit_add_delete_size.php?add=ture",
                data: {
                    sizename:sizename 
                },
